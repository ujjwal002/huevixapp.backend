...
const title = process.argv[2] || "💙 Thank You!";
const body = process.argv[3] || "Amazing people! Thanks for trying our app. If you opted out, we'd love your feedback—it helps us improve.";
