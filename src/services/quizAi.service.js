...
function mockQuestions() {
  ...
  return [
    ...
    },
    {
      ...
      correctIndex: 1,
      explanation: 'The Royal Bengal Tiger is the national animal.',
    },
    {
    ...
    {
      prompt: 'How many players are there in a cricket team?',
      options: ['9', '10', '11', '12'],
      correctIndex: 2,
    ...
    },
    {
      ...
      options: ['3,000 km/s', '30,000 km/s', '3,00,000 km/s', '30,00,000 km/s'],
      correctIndex: 2,
      explanation: 'Light travels about 3,00,000 km/s.',
    },
    {
      prompt: 'The Taj Mahal is located in which city?',
      options: ['Delhi', 'Agra', 'Jaipur', 'Lucknow'],
      correctIndex: 1,
      explanation: 'The Taj Mahal is in Agra.',
    },
    {
    ...
    },
    {
      ...
      correctIndex: 1,
      explanation: 'Neil Armstrong was first, in 1969.',
    },
    {
      prompt: 'How many bones are there in the adult human body?',
      options: ['206', '201', '210', '200'],
      correctIndex: 0,
    ...
    },
    {
      ...
      options: ['5', '6', '7', '8'],
      correctIndex: 2,
      explanation: 'A rainbow has 7 colours (VIBGYOR).',
    },
    {
      prompt: 'Which is the largest mammal in the world?',
